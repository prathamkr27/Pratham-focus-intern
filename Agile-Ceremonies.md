...
From my experience of attending the standup , i realised that this is a really short and casual meeting type with no small talk or distractions . The meetings straighforward and direct , all the intern takes turn and  show there progres and ask the doubts . So last week in the standup meeting I attended with jeremy where i asked my doubts about how to progess in my project about the attention score model. In repsonse jeremey gave me freedom an guidance that i chose whichevr method i want and can ask for help if stuck. 


Document one change you can make to improve your team collaboration.

One change i can make to improve my collabortion will be giving my updates through email or discord if i am not available to attended my allocated meeting time , or if possible i can ask my supervisor if i can access other meetings as well , this way i will stay proactive and my progres will be continosuly reviewed by my supervisor.

Participate in a retrospective or review past notes from one.

While I haven't participated in a live retrospective yet, reviewing the previous session notes was incredibly eye-opening. I noticed a significant shift in depth compared to our daily standups; the supervisor provided much more comprehensive guidance that went beyond simple status updates. Having that level of detailed feedback at the end of the cycle is a powerful way to track our progress and maintain a positive trajectory.

What are the main Agile ceremonies and their purpose

"Agile" is a project management philosophy focused on building things in small, continuous cycles rather than trying to deliver a massive project all at once. To keep these cycles organized and the team communicating, Agile relies on recurring meetings known as "ceremonies."
